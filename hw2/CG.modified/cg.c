...
int main(int argc, char *argv[])
{
  ...
  //---------------------------------------------------------------------
  //  This function take a lot of time // TODO
  //---------------------------------------------------------------------
                   ...
                   double shift)
{
  ...
  /*for(si=1;si<n;si++){
    size_array[si] = size_array[si-1]*ratio;
  }
  */
...
//# pragma omp for schedule(static,1)
  for (i = 0; i < n; i++) {
    int nza;
    //double size = size_array[i];
    //sleep(1);
    //printf("my i is :%d , size is %.13lf\n",i,size);
    
    for (nza = 0; nza < arow[i]; nza++) {
      // naz : non-zero term index for each row  
      int j,jcol,nzrow,k,kk;
      double scale,va;
      j = acol[i][nza];
      logical cont40;
